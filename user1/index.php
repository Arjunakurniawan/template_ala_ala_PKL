              ...
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg">
                    <h5>Perluas Jangkauan Bisnis Anda dengan Website</h5>
                    <p class="mt-4 pr-lg-4">Website telah menjadi kebutuhan dasar untuk mengembangkan bisnis Anda di era
                      digital ini. Oleh sebab itu, #onlenkanbisnismu untuk naik ke level dunia!</p>
                    <a class="btn btn-style btn-primary mt-sm-5 mt-4 mr-2" href="about.php"> Hubungi Kami
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div class="row footer-top-29">
          ...
          <div class="col-lg-2 col-md-6 col-sm-5 col-6 footer-list-29 footer-3 mt-lg-0 mt-5">
            <ul>
              ...
              <li><a href="">Fokus kelola bisnis Anda, biar kami yang Onlenkan!</a></li>
            </ul>
          </div>
