        ...
        <div class="container">
            <div class="d-grid contact-view">
                <div class="cont-details">
                    <h4 class="title-small">Kritik & Saran</h4>
                    <h3 class="title-big mb-4">Konsultasi dengan kami GRATIS!</h3>
                    <p class="mb-sm-5 mb-4">Kami siap membantu dan menolong bisnis anda, hubungi kami untuk berdiskusi, GRATIS!</p>
                    ...
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Address</h6>
                            <p class="pr-lg-5">Jl. Dr.Sutomo No.141, Mangunharjo, Kec. Mayangan, Kota Probolinggo, Jawa Timur 67211</p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Phone</h6>
                            <p><a href="tel:+(21) 255 999 8888">6287777000032</a></p>
                        </div>
                    </div>
                </div>
                <div class="map-content-9">
                    <h5 class="mb-sm-4 mb-3">Tuliskan Sesuatu</h5>
                    <form action="" method="post">
                        <div class="twice-two">
                            <input type="text" class="form-control" name="xnama" placeholder="Nama"
                                required="">
                            <input type="email" class="form-control" name="xemail" placeholder="Email"
                                required="">
                            
                            <input type="date" class="form-control" name="xpesan" placeholder="tanggal"
                                required="">
                            
                        </div>
                        <textarea name="xpesan" class="form-control" placeholder="Message"
                            required=""></textarea>
                        <div class="text-right">
                            <input type="submit" name="kirim" value="Kirim" class="btn btn-primary btn-style mt-4">
                        </div>
                        <?php 
                          if(isset($_POST['kirim'])){
                              ...
                              echo "<script>alert('Pesan berhasil dikirim');location='contact.php'</script>";
                          }
                          ?>
                    </form>
                </div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.38245539843!2d113.21559071406077!3d-7.749196478977596!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7ad9d4bacb9cb%3A0x17220e29c756119b!2sOnlenkan.com%20-%20Jasa%20Pembuatan%20Website%20%26%20Aplikasi%20Probolinggo!5e0!3m2!1sen!2sid!4v1674879172667!5m2!1sen!2sid" 
...
<section class="w3l-footer-29-main">
  ...
  <section class="w3l-copyright text-center">
    <div class="container">
      <p class="copy-footer-29">Copyright © 2023 Onlenkan Studio. All right reserved
    </div>
