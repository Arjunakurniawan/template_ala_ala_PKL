    ...
    if(!empty($_SESSION['iduser'])){
        ...
        if(@$_POST['login']){
            ...
            if(mysqli_num_rows($q) > 0){
                ...
                echo "<script>alert('Data yg anda masukkan salah!');location='login.php'</script>";
            }
        }
?>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img src="logo.png" width="115%"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Login Us</h1>
                                    </div>
