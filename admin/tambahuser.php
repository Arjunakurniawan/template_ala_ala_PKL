    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Tambah Data User</h1>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <textarea class="form-control" id="inputPassword3" name="alamat"></textarea>
                </div>
            </div>
            <div class="row mb-3">
...
<?php 
    if(isset($_POST['tambah'])){
        ...
        $d = mysqli_query($koneksi, "insert into tb_user value('$id_user', '$nama_user', '$telepon', '$alamat', '$username', '$password')");
