...
$id = $_GET['id_user'];
$edit = mysqli_query($koneksi, "SELECT * FROM tb_user where id_user='$id'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Form Ubah Data User</h1>
                    <form method="POST" action="" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <label for="inputPassword3" class="col-sm-2 col-form-label">Nama User</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputPassword3" name="nama_user"
                                    value="<?php echo $r['nama_user']?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputPassword3" class="col-sm-2 col-form-label">Telepon</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputPassword3" name="telepon"
...
if(isset($_POST['ubah'])){
    ...
    $d = mysqli_query($koneksi, "UPDATE tb_user SET nama_user='$nama_user', telepon='$telepon', alamat='$alamat', username='$username', password='$password' WHERE id_user = '$id'");
