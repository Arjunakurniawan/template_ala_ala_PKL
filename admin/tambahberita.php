        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Berita</h1>
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="inputPassword3" name="isi_berita"></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
...
<?php 
    if(isset($_POST['tambah'])){
        ...
        $d = mysqli_query($koneksi, "insert into tb_berita value('$id_berita', '$judul', '$tgl_post', '$id_user', '$isi_berita', '$gambar')");
