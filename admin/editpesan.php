...
$id = $_GET['id_pesan'];
$edit = mysqli_query($koneksi, "SELECT * FROM tb_pesan where id_pesan='$id'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Form Ubah Data Pesan</h1>
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="inputPassword3" class="col-sm-2 col-form-label">Pesan</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="inputPassword3"
                                    name="pesan"><?php echo $r['pesan']?></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputPassword3" class="col-sm-2 col-form-label">Tanggal Terkirim</label>
                            <div class="col-sm-10">
...
if(isset($_POST['ubah'])){
    ...
    $d = mysqli_query($koneksi, "UPDATE tb_pesan SET nama='$nama', email='$email', pesan='$pesan', tanggal='$tanggal' WHERE id_pesan = '$id'");
