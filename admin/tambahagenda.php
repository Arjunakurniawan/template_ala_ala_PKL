    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Agenda</h1>
                <form method="POST" action="" enctype="multipart/form-data">
            <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Tanggal Agenda</label>
                <div class="col-sm-10">
                <input type="date" class="form-control" id="inputPassword3" name="tgl_agenda">
                </div>
            </div>
            <div class="row mb-3">
...
<?php 
    if(isset($_POST['tambah'])){
        ...
        $d = mysqli_query($koneksi, "insert into tb_agenda value('$id_agenda', '$tgl_agenda', '$agenda', '$deskripsi', '$id_user', '$gambar')");
