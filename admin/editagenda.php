...
$id = $_GET['id_kegiatan'];
$edit = mysqli_query($koneksi, "SELECT * FROM tb_agenda where id_agenda='$id'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Form Ubah Data agenda</h1>
                    <form method="POST" action="" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <label for="inputPassword3" class="col-sm-2 col-form-label">Tanggal agenda</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="inputPassword3" name="tgl_kegiatan"
                                    value="<?php echo $r['tgl_agenda']?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputPassword3" class="col-sm-2 col-form-label">agenda</label>
                            <div class="col-sm-10">
                                <input type="tel" class="form-control" id="inputPassword3" name="agenda"
                                    value="<?php echo $r['agenda']?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputPassword3" name="id_user"
...
<?php 
    if(isset($_POST['ubah'])){
        ...
        if(empty($gambar)){
            $d = mysqli_query($koneksi, "UPDATE tb_agenda SET  tgl_agenda='$tgl_agenda', agenda='$agenda', deskripsi='$deskripsi', id_user='$id_user' WHERE id_agenda = '$id'");
        }else{
            $d = mysqli_query($koneksi, "UPDATE tb_agenda SET  tgl_agenda='$tgl_agenda', gambar='$agenda', deskripsi='$deskripsi', id_user='$id_user', gambar='$gambar'  WHERE id_agenda = '$id'");
