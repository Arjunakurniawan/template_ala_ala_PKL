...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Galery</h1>
    ...
    if(isset($_POST['tambah'])){
        ...
        $d = mysqli_query($koneksi, "insert into tb_galery value('$id_galery', '$judul_galery', '$gambar', '$tanggal', '$id_user')");
