        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Form Ubah Data Biodata</h1>
                    <form method="POST" action="" enctype="multipart/form-data">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputPassword3" name="nama_perusahaan"
                                    value="<?php echo $r['nama_perusahaan']?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img src="../gambar/<?php echo $r['logo_perusahaan']; ?>" width="150px" height="100px">
...
<?php 
    if(isset($_POST['ubah'])){
        ...
        if(empty($logo_perusahaan)){
            $d = mysqli_query($koneksi, "UPDATE tb_biodata SET  nama_perusahaan='$nama_perusahaan', telepon='$telepon', alamat='$alamat', nama_pimpinan='$nama_pimpinan', visi='$visi', misi='$misi' WHERE id_biodata = '$id'");
        }else{
            $d = mysqli_query($koneksi, "UPDATE tb_biodata SET  nama_perusahaan='$nama_perusahaan', telepon='$telepon', alamat='$alamat', nama_pimpinan='$nama_pimpinan', logo_perusahaan='$logo_perusahaan', visi='$visi', misi='$misi' WHERE id_biodata = '$id'");
